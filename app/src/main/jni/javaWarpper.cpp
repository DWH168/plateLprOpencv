...
Java_com_plate_lpr_PlateRecognition_InitPlateRecognizer(
...
Java_com_plate_lpr_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jobject obj,
...
Java_com_plate_lpr_PlateRecognition_ReleasePlateRecognizer(JNIEnv *env, jobject obj,
                                                               jlong object_re) {
